...
<Card>
    ...
    Further, advanced fine-tuning and configuration can be done in TypeScript with the files in the `/config` folder. See the [Configuration Files](/configuration/config) page for more information.
</Card>
</Cards>
